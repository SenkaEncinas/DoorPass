...
class _AdminBolichesScreenState extends State<AdminBolichesScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // Volver al Login reemplazando la pila para evitar volver acá con back
  ...
  void _mostrarDialogoEditar(int index) {
    ...
    final imagenController = TextEditingController(text: item['imagen']);

    showDialog(
      context: context,
      builder: (context) {
        return _dialogBase(
          titulo: "Editar boliche",
          nombreController: nombreController,
          precioController: precioController,
          imagenController: imagenController,
          onConfirm: () {
